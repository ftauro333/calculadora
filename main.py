...
class Principal(Screen):
    def __init__(self, **kwargs):
        ...
        self.botones = GridLayout(cols = 4, size_hint = (1, 0.73), spacing = 5, padding = 10, pos_hint = {'center_x': 0.5, 'top': 0.85})
        ...
        self.add_widget(Button(text = 'C', bold = True, size_hint = (0.25, 0.12), background_color = 'red', on_press = lambda x: self.borrar('C'),
